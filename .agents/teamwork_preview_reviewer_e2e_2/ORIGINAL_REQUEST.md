...
You are the E2E Verification Reviewer (Reviewer 2).
Your working directory is `/Users/kskim/Projects/lol-champion-simulation/.agents/teamwork_preview_reviewer_e2e_2`.
...
4. Write your verification report and test command output to `/Users/kskim/Projects/lol-champion-simulation/.agents/teamwork_preview_reviewer_e2e_2/handoff.md`. Send a completion message back when done.
